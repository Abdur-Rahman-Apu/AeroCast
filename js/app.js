...
const data = {
  ...
  Aruba: ["Oranjestad", "Tanki Leendert"],
  Australia: [
    "Melbourne",
    "Sydney",
    "Brisbane",
  ...
  Grenada: ["Saint David's", "Saint George's"],
  ...
  "New Caledonia": ["Noumea", "Dumbea", "Mont-Dore", "Paita", "Kone", "We"],
  "New Zealand": [
    "Auckland",
    "Christchurch",
    "Manukau City",
  ...
  Palau: ["Koror", "Melekeok", "Ngerulmud"],
  Panama: [
    "Panama City",
    "San Miguelito",
    "David",
  ...
  "Saint Lucia": ["Castries", "Gros Islet", "Micoud", "Vieux Fort", "Bisee"],
  "Saint Martin": ["Marigot"],
  "Saint Pierre and Miquelon": ["Saint-Pierre"],
  "Saint Vincent and the Grenadines": ["Calliaqua", "Kingstown"],
  Samoa: [
    "Apia",
    "Afega",
    "Safotu",
